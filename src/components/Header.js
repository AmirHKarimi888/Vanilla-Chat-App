...
<header>
    <nav
        class="fixed top-0 left-0 w-full bg-blue-500 text-white p-3 border-b border-gray-400 grid grid-cols-3 justify-center items-center shadow-md shadow-gray-300">
